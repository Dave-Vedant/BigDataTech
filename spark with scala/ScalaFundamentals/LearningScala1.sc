object LearningScala1 {
  ...
  val hello: String = "Banjour!"                  //> hello  : String = Banjour!
  println(hello)                                  //> Banjour!
  
  val vedant : String = "Dave117"                 //> vedant  : String = Dave117
  println(vedant)                                 //> Dave117
  ...
  var helloThere: String = hello                  //> helloThere  : String = Banjour!
  helloThere = hello + " There!"
  println(helloThere)                             //> Banjour! There!
  ...
  val immutableHelloThere = hello + "Every One!"  //> immutableHelloThere  : String = Banjour!Every One!
  println(immutableHelloThere)                    //> Banjour!Every One!
  
  val fullname = vedant + " is my nick name!"     //> fullname  : String = Dave117 is my nick name!
  println(fullname)                               //> Dave117 is my nick name!
  ...
  println(s"I can use the s prefix to use variables like $numberOne $truth $letterA")
	...
	println(s"My current age is ${25} years") //> My current age is 25 years
  ...
  val test : Boolean = picard == vedant           //> test  : Boolean = false
  ...
  // Let's try
  val x : Double = 3.142731                       //> x  : Double = 3.142731
  val y : Double = 2*x                            //> y  : Double = 6.285462
  println(f"The value of the output is $y%.3f")   //> The value of the output is 6.285
