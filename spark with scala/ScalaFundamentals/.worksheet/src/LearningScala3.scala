object LearningScala3 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(225); 
  ...
  transformInt(2, x => {val y = x * 2; y * y});System.out.println("""res2: Int = """ + $show(res$2));$skip(415); 
  ...
  x.toUpperCase()
  };System.out.println("""uppercase: (x: String)String""");$skip(65); 
  
  def lowercase(x: String) : String = {
  x.toLowerCase()
  };System.out.println("""lowercase: (x: String)String""");$skip(74); 
  
  def convert(x: String, f: String => String) : String = {
  f	(x)
  };System.out.println("""convert: (x: String, f: String => String)String""");$skip(25); val res$3 = 
  
  uppercase("Vedant");System.out.println("""res3: String = """ + $show(res$3));$skip(20); val res$4 = 
  lowercase("dave");System.out.println("""res4: String = """ + $show(res$4));$skip(65); 
  
  val ans = convert("Machine Learning Engineer", (lowercase));System.out.println("""ans  : String = """ + $show(ans ));$skip(66); val res$5 = 
  
  // lambda function
  convert("vedant", x => x.toUpperCase());System.out.println("""res5: String = """ + $show(res$5))}
}
